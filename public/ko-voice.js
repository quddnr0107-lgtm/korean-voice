...
(function (root, factory) {
  ...
  // 발음 관용이 분명한 K1/K2/K9만 명시하고, 복합 모델명은 일반 영어 처리를 유지한다.
  const MILITARY_MODEL = { K1: '케이원', 'K-1': '케이원', K2: '케이투', 'K-2': '케이투', K9: '케이나인', 'K-9': '케이나인' };
  ...
  function normalize(text) {
    ...
    t = t.replace(/\bK-?(?:1|2|9)\b/gi, (m) => MILITARY_MODEL[m.toUpperCase()] || m);
