...
음높이 중앙 219Hz(151~308), 4.9음절/초, 구 사이 쉼 320ms, 문장 사이 890ms, 문장 안 하강 −3.7%, 문장 끝 상승 52%(대화체).
15개→21개→37개로 늘려도 음높이·말속도·쉼은 거의 같다(측정이 안정적). 하강폭만 −7.7%→−3.7%로 줄었다 —
긴 녹음이 늘어 문장 안 억양이 더 평탄한 대화체가 반영된 것. `synth-supertonic.py`는 이 프로필을 기본으로 쓴다(04번 청취 선택).
